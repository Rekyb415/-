...
const ENRICHED = {
  ...
  "杆": { readings: {
    "gān": { meaning_zh:"旗杆，电线杆", meaning_en:"flagpole, utility pole", example_zh:"旗杆", example_pinyin:"qí gān", example_en:"flagpole", meaning_vi:"cột, sào (dài)", example_vi:"cột cờ", frequency:"medium" },
  ...
  "朴": { readings: {
    ...
    "piáo": { meaning_zh:"姓（朝鲜族姓氏）", meaning_en:"Piao (Korean surname)", example_zh:"姓朴", example_pinyin:"xìng Piáo", example_en:"surname Park", meaning_vi:"họ Phác (Triều Tiên)", example_vi:"họ Phác", frequency:"low" },
    "pò": { meaning_zh:"朴树（落叶乔木）", meaning_en:"hackberry tree", example_zh:"朴树", example_pinyin:"pò shù", example_en:"hackberry tree", meaning_vi:"cây phác (cây gỗ rụng lá)", example_vi:"cây phác", frequency:"low" },
    "pō": { meaning_zh:"朴刀（古代兵器）", meaning_en:"pudao (old weapon)", example_zh:"朴刀", example_pinyin:"pō dāo", example_en:"pudao (a long-handled blade)", meaning_vi:"đao phác (binh khí cổ)", example_vi:"đao phác", frequency:"low" },
  }},
  "戚": { readings: {
  ...
  "任": { readings: {
    "rén": { meaning_zh:"姓；任丘（地名）", meaning_en:"surname; place name", example_zh:"姓任", example_pinyin:"xìng Rén", example_en:"surname Ren", meaning_vi:"họ Nhậm; địa danh Nhậm Khâu", example_vi:"họ Nhậm", frequency:"low" },
    "rèn": { meaning_zh:"任命，担任；任务", meaning_en:"to appoint; task", example_zh:"任务", example_pinyin:"rèn wu", example_en:"task, mission", meaning_vi:"bổ nhiệm, đảm nhận; nhiệm vụ", example_vi:"nhiệm vụ", frequency:"high" },
  }},
  "刹": { readings: {
  ...
  "杠": { readings: {
    "gàng": { meaning_zh:"杠子，单杠，抬杠", meaning_en:"bar; to argue", example_zh:"单杠", example_pinyin:"dān gàng", example_en:"horizontal bar", meaning_vi:"đòn, xà; cãi cùn (抬杠)", example_vi:"xà đơn", frequency:"medium" },
    "gāng": { meaning_zh:"桥（书面、罕用）", meaning_en:"bridge (literary, rare)", example_zh:"石杠", example_pinyin:"shí gāng", example_en:"stone bridge", meaning_vi:"cầu (văn viết, hiếm)", example_vi:"cầu đá", frequency:"low" },
  }},
  "膏": { readings: {
    "gāo": { meaning_zh:"脂肪，油；膏药", meaning_en:"fat, paste, ointment", example_zh:"牙膏", example_pinyin:"yá gāo", example_en:"toothpaste", meaning_vi:"mỡ, dầu; thuốc cao, kem", example_vi:"kem đánh răng", frequency:"high" },
    "gào": { meaning_zh:"加润滑油；滋润（动词）", meaning_en:"to lubricate, to oil", example_zh:"膏油", example_pinyin:"gào yóu", example_en:"to lubricate with oil", meaning_vi:"tra dầu, bôi trơn (động từ)", example_vi:"tra dầu", frequency:"low" },
  }},
  "搁": { readings: {
    ...
    "gé": { meaning_zh:"禁受，承受", meaning_en:"to bear, to withstand", example_zh:"搁不住", example_pinyin:"gé bu zhù", example_en:"can't withstand", meaning_vi:"chịu đựng, kham nổi (khẩu ngữ)", example_vi:"không chịu nổi", frequency:"medium" },
  }},
  "给": { readings: {
  ...
  "混": { readings: {
    "hùn": { meaning_zh:"掺杂，混合；混沌", meaning_en:"to mix; chaos", example_zh:"混合", example_pinyin:"hùn hé", example_en:"to mix", meaning_vi:"trộn lẫn; hỗn loạn", example_vi:"trộn lẫn", frequency:"high" },
    "hún": { meaning_zh:"同\"浑\"（浑浊；糊涂）", meaning_en:"muddy; muddleheaded (= 浑)", example_zh:"混蛋", example_pinyin:"hún dàn", example_en:"scoundrel", meaning_vi:"đục; hồ đồ (như chữ 浑)", example_vi:"đồ khốn", frequency:"medium" },
  }},
  "霍": { readings: {
  ...
  "乌": { readings: {
    ...
    "wù": { meaning_zh:"乌拉草（植物）", meaning_en:"Ula sedge (plant)", example_zh:"乌拉草", example_pinyin:"wù la cǎo", example_en:"Ula sedge", meaning_vi:"cỏ Ula (乌拉草)", example_vi:"cỏ Ula", frequency:"low" },
  }},
  "洗": { readings: {
